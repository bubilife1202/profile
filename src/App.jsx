...
export default function App() {
  return (
    <div className="min-h-screen">
      ...
      <section className="hero">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="animate-fade-in delay-1 heading-hero mb-8">
              유튜브, 아직도 <span className="gradient-text">'감'</span>으로 하시나요?
              <br />
              이제 <span className="text-blue-400">'데이터'</span>로 승부하세요.
            </h1>

            <p className="animate-fade-in delay-2 text-body-lg max-w-2xl mx-auto mb-12">
              매달 나가는 유료 툴 비용은 그만.
              <br />
              단 한 번의 결제로 평생 쓰는 분석 도구와 떡상 데이터를 드립니다.
            </p>

            <div className="animate-fade-in delay-3 flex flex-col sm:flex-row gap-4 justify-center mb-10">
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="heading-section mb-4">백문이 불여일견</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="card">
              <div className="flex items-center gap-4 mb-6">
                <div className="feature-icon w-12 h-12 rounded-xl bg-orange-500/10">
                  <Play className="w-5 h-5 text-orange-400" />
                </div>
                <div>
                  <p className="font-semibold text-lg">'이거 진짜 되나요?'</p>
                  <p className="text-sm text-zinc-500">시연 영상</p>
                </div>
              </div>
            ...
            <div className="card">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <p className="font-semibold text-lg">프로그램 실제 작동</p>
                  <p className="text-sm text-zinc-500">작동 화면</p>
                </div>
              </div>
              <div className="video-wrapper">
                <iframe
      ...
      <section id="products" className="section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="heading-section mb-4">입문자부터 전문가까지</h2>
          ...
          <div className="product-grid max-w-6xl mx-auto">
            ...
            <div className="card product-card">
              <div className="product-card-content">
                <div className="flex items-center justify-between mb-8">
                  <div className="feature-icon w-14 h-14 rounded-2xl bg-emerald-500/10">
                    <Gift className="w-7 h-7 text-emerald-400" />
                  </div>
                  <span className="badge badge-emerald">입문용</span>
                </div>

                <h3 className="text-2xl font-bold mb-3">무료 데이터 맛보기</h3>
                ...
                <ul className="feature-list mb-10 product-card-features">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn btn-lg btn-ghost btn-emerald w-full"
                >
            ...
            {/* ===== BEST ===== */}
            <div className="card card-featured product-card product-card-featured">
              <div className="product-card-content">
                ...
                <div className="flex items-center justify-between mb-8 mt-2">
                  <div className="feature-icon w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500/20 to-purple-500/20">
                    <Target className="w-7 h-7 text-blue-400" />
                  </div>
                  <span className="badge badge-purple">가성비 끝판왕</span>
                </div>

                <h3 className="text-2xl font-bold mb-3">블루오션 키워드 파인더</h3>
            ...
            <div className="card product-card">
              <div className="product-card-content">
                ...
                <h3 className="text-2xl font-bold mb-3">AI 쇼츠 레이더 PRO</h3>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn btn-lg btn-ghost btn-blue w-full"
                >
          ...
          <div className="max-w-3xl mx-auto">
            <div className="card text-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-lg text-purple-400 hover:text-purple-300 transition-colors font-semibold"
              >
      ...
      {/* ==================== FOOTER ==================== */}
      <footer className="section py-20 md:py-28">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h3 className="text-2xl md:text-3xl font-bold mb-10">궁금한 점이 있으신가요?</h3>
